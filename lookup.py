...
file_to_sourcetype_lookup = {
    ...
    "authkey_linux-sysmon": "sysmon_linux",
    ...
    "gdrive_share_external": "gws:reports:drive",
    "gdrive_susp_attach": "gws:reports:drive",
    ...
    "gsuite_external_domain": "google:bigquery:table",
    "gsuite_gmail_file_ext": "google:bigquery:table",
    "gsuite_susp_subj_attach": "google:bigquery:table",
    "gsuite_susp_url": "google:bigquery:table",
    ...
    "sysmon_linux_cron_append": "sysmon_linux",
